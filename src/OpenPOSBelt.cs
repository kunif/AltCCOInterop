...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.Belt, "OpenPOS Belt", "OPOS Belt Alternative CCO Interop", 1, 14)]

    public class OpenPOSBelt : Belt, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSBelt _cco = null;
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposedValue)
            {
                ...
                if (_cco != null)
                {
                    _cco.DirectIOEvent -= (POS.Devices._IOPOSBeltEvents_DirectIOEventEventHandler)_cco_DirectIOEvent;
                    _cco.StatusUpdateEvent -= (POS.Devices._IOPOSBeltEvents_StatusUpdateEventEventHandler)_cco_StatusUpdateEvent;
                    _cco = null;
                }
