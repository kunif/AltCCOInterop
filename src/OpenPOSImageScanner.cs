...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.ImageScanner, "OpenPOS ImageScanner", "OPOS ImageScanner Alternative CCO Interop", 1, 14)]

    public class OpenPOSImageScanner : ImageScanner, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSImageScanner _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSImageScanner();
