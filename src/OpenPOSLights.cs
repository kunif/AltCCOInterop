...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.Lights, "OpenPOS Lights", "OPOS Lights Alternative CCO Interop", 1, 14)]

    public class OpenPOSLights : Lights, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSLights _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSLights();
