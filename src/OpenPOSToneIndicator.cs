...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.ToneIndicator, "OpenPOS ToneIndicator", "OPOS ToneIndicator Alternative CCO Interop", 1, 14)]

    public class OpenPOSToneIndicator : ToneIndicator, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSToneIndicator _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSToneIndicator();
