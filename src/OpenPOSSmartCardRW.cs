...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.SmartCardRW, "OpenPOS SmartCardRW", "OPOS SmartCardRW Alternative CCO Interop", 1, 14)]

    public class OpenPOSSmartCardRW : SmartCardRW, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSSmartCardRW _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSSmartCardRW();
