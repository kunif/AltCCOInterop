...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.PosKeyboard, "OpenPOS POSKeyboard", "OPOS POSKeyboard Alternative CCO Interop", 1, 14)]

    public class OpenPOSPOSKeyboard : PosKeyboard, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSPOSKeyboard _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSPOSKeyboard();
