...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.Keylock, "OpenPOS Keylock", "OPOS Keylock Alternative CCO Interop", 1, 14)]

    public class OpenPOSKeylock : Keylock, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSKeylock _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSKeylock();
