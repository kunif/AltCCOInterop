...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.MotionSensor, "OpenPOS MotionSensor", "OPOS MotionSensor Alternative CCO Interop", 1, 14)]

    public class OpenPOSMotionSensor : MotionSensor, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSMotionSensor _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSMotionSensor();
