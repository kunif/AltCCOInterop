...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.Scanner, "OpenPOS Scanner", "OPOS Scanner Alternative CCO Interop", 1, 14)]

    public class OpenPOSScanner : Scanner, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSScanner _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSScanner();
