...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.CashDrawer, "OpenPOS CashDrawer", "OPOS CashDrawer Alternative CCO Interop", 1, 14)]

    public class OpenPOSCashDrawer : CashDrawer, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSCashDrawer _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSCashDrawer();
