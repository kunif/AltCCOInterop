...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.SignatureCapture, "OpenPOS SignatureCapture", "OPOS SignatureCapture Alternative CCO Interop", 1, 14)]

    public class OpenPOSSignatureCapture : SignatureCapture, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSSigCap _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSSigCap();
