...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.ItemDispenser, "OpenPOS ItemDispenser", "OPOS ItemDispenser Alternative CCO Interop", 1, 14)]

    public class OpenPOSItemDispenser : ItemDispenser, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSItemDispenser _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSItemDispenser();
