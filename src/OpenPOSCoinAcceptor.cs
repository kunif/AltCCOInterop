...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.CoinAcceptor, "OpenPOS CoinAcceptor", "OPOS CoinAcceptor Alternative CCO Interop", 1, 14)]

    public class OpenPOSCoinAcceptor : CoinAcceptor, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSCoinAcceptor _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSCoinAcceptor();
