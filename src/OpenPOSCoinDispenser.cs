...
namespace POS.AltCCOInterop
{
    ...
    [ServiceObject(DeviceType.CoinDispenser, "OpenPOS CoinDispenser", "OPOS CoinDispenser Alternative CCO Interop", 1, 14)]

    public class OpenPOSCoinDispenser : CoinDispenser, ILegacyControlObject, IDisposable
    {
        private POS.Devices.OPOSCoinDispenser _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new POS.Devices.OPOSCoinDispenser();
